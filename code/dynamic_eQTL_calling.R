...
saveRDS(coef_snps_by_gene, paste0("/work-zfs/abattle4/prashanthi/sc-endo/results/eQTL_calling/", cell_type, "/stegle/coef_snps_by_gene_", start_pos, "to", end_pos, ".rds"))
saveRDS(pseudotime_by_gene, paste0("/work-zfs/abattle4/prashanthi/sc-endo/results/eQTL_calling/", cell_type, "/stegle/pseudotime_by_gene_", start_pos, "to", end_pos, ".rds"))
saveRDS(interaction_by_gene, paste0("/work-zfs/abattle4/prashanthi/sc-endo/results/eQTL_calling/", cell_type, "/stegle/interaction_by_gene_", start_pos, "to", end_pos, ".rds"))
