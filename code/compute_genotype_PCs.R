...
filename <- "/work-zfs/abattle4/prashanthi/sc-endo/data/genotypes/genotypes_all.gds"
...
pdf(paste0(plots.dir, "genotype_PCs_scree.pdf"))
plot(pc.percent, pch = 20, xlim = c(1,20), xlab = "PC Number", 
     ylab = "% Variance explained", main = "Scree plot Genotype PCs")
lines(pc.percent)
dev.off()
...
saveRDS(eigen_vectors, "/work-zfs/abattle4/prashanthi/sc-endo/data/genotypes/genotype_PCs.rds")
